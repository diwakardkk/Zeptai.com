          ...
          <div className="grid gap-12 lg:grid-cols-[1.15fr_0.85fr] items-center">
            <div>
              ...
              <h2 className="mt-6 text-4xl md:text-5xl font-bold tracking-tight text-foreground">
                Get ZeptAI on iOS and Android
              </h2>
              <p className="mt-6 text-lg leading-8 text-muted-foreground max-w-2xl">
                Experience the future of clinical intake on mobile. Instantly capture patient symptoms, generate prescreening reports, and keep your practice efficient from anywhere.
              </p>
              ...
              <div className="relative grid gap-6">
                <div className="rounded-[2rem] bg-gradient-to-br from-primary/90 to-blue-600 p-6 text-primary-foreground shadow-xl shadow-primary/20">
                  <div className="flex items-center justify-between">
                    <span className="text-sm font-semibold uppercase tracking-[0.2em]">Mobile AI</span>
                    <span className="text-xs bg-white/10 px-3 py-1 rounded-full">Live</span>
                  </div>
                  <div className="mt-8 space-y-3">
                    <div className="text-4xl font-bold">ZeptAI</div>
                    <p className="text-sm text-primary-foreground/90">
                      Voice-first patient intake with instant clinical reports.
                    </p>
                  </div>
                </div>
                <div className="rounded-[2rem] bg-background p-6 shadow-inner shadow-black/5">
                  <div className="flex items-center justify-between text-sm text-muted-foreground">
                    <span>Symptom capture</span>
                  ...
                  <div className="mt-6 rounded-3xl border border-border bg-secondary/10 p-5 text-sm text-foreground">
                    <p>Headache, Cough, Fever</p>
                    <p className="mt-3 text-xs text-muted-foreground">Generated in seconds</p>
                  </div>
                </div>
              </div>
            </div>
