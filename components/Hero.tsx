      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 text-center">
        ...
        >
          <span className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-primary/10 text-primary border border-primary/20 text-sm font-medium mb-6">
            ...
            SCIE Q1 Research Backed Platform
          </span>
          <h1 className="text-5xl md:text-7xl font-extrabold tracking-tighter text-foreground mb-6">
            AI That Talks <br className="hidden sm:block" /> Like a <span className="text-primary">Doctor</span>
          </h1>
          <p className="mt-4 max-w-2xl mx-auto text-xl text-muted-foreground mb-10">
            An intelligent virtual assistant designed to streamline the patient intake process in clinics and hospitals. Generate Pre-screening Reports efficiently before the consultation starts.
          </p>
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
            ...
            >
              <PlayCircle className="w-5 h-5" /> Live AI Demo
            </Link>
          </div>
        </motion.div>
              ...
              <div className="p-8 sm:p-12 text-left">
                <div className="flex gap-4 mb-6">
                  ...
                  <div className="bg-muted p-4 rounded-2xl rounded-tl-sm text-sm sm:text-base">
                    Hello! I&apos;m ZeptAI, your virtual medical assistant. Can you tell me what symptoms you are currently experiencing?
                  </div>
                </div>
                <div className="flex gap-4 justify-end mb-6">
                  <div className="bg-primary/20 text-foreground p-4 rounded-2xl rounded-tr-sm text-sm sm:text-base border border-primary/30 max-w-md">
                    I&apos;ve been having a severe headache for the past two days, along with some nausea.
                  </div>
