      ...
      <section className="relative overflow-hidden pb-16 pt-24">
        ...
        <div className="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="mx-auto max-w-3xl text-center">
            <span className="inline-flex items-center gap-2 rounded-full border border-[#224bc3]/25 bg-card/88 px-4 py-1 text-xs font-semibold uppercase tracking-[0.17em] text-[#224bc3]">
              ZeptAI Pricing
            </span>
          ...
          <div className="mt-8 grid gap-4 rounded-3xl border border-border bg-card/85 p-5 text-sm text-muted-foreground shadow-[0_24px_60px_-42px_rgba(0,0,0,0.45)] backdrop-blur md:grid-cols-3">
            <div className="rounded-2xl border border-border bg-card/90 px-4 py-4">
              <div className="font-semibold text-foreground">Razorpay Ready</div>
              <div className="mt-1">Hosted checkout slot prepared on UI</div>
            </div>
            <div className="rounded-2xl border border-border bg-card/90 px-4 py-4">
              <div className="font-semibold text-foreground">INR Per Report</div>
              <div className="mt-1">Simple and transparent pricing slabs</div>
            </div>
            <div className="rounded-2xl border border-border bg-card/90 px-4 py-4">
              <div className="font-semibold text-foreground">Scale Anytime</div>
              <div className="mt-1">Customize doctor and report usage instantly</div>
            </div>
          </div>

          <div className="mt-12 grid gap-6 lg:grid-cols-3">
            <section className="rounded-[2rem] border border-border bg-card/90 p-6 shadow-[0_18px_45px_-30px_rgba(0,0,0,0.6)] backdrop-blur transition duration-300 hover:-translate-y-1 hover:shadow-[0_26px_50px_-28px_rgba(0,0,0,0.55)]">
              <div className="inline-flex h-11 w-11 items-center justify-center rounded-2xl bg-[#38ac06]/10 text-[#38ac06]">
                <TestTube2 className="h-5 w-5" />
              </div>
              <p className="mt-5 text-xs font-semibold uppercase tracking-[0.16em] text-muted-foreground">Trial Plan</p>
              <h2 className="mt-2 text-2xl font-bold text-foreground">Start Fast</h2>
              <p className="mt-2 text-sm leading-6 text-muted-foreground">
                Entry-level plan to test patient intake and summary quality with minimal setup.
              </p>

              <div className="mt-6 rounded-2xl border border-border bg-card/90 p-4">
                <p className="text-sm text-muted-foreground">Pricing</p>
                <p className="mt-1 text-3xl font-extrabold text-foreground">₹0</p>
                <p className="text-sm text-muted-foreground">50 reports included (trial)</p>
              </div>
            ...
            <section className="relative rounded-[2rem] border border-[#224bc3]/30 bg-gradient-to-b from-card/95 to-background/95 p-6 shadow-[0_22px_60px_-36px_rgba(34,75,195,0.7)] backdrop-blur transition duration-300 hover:-translate-y-1.5 hover:shadow-[0_30px_70px_-34px_rgba(34,75,195,0.65)] dark:to-card/90">
              ...
              <p className="mt-5 text-xs font-semibold uppercase tracking-[0.16em] text-muted-foreground">Clinic Plan</p>
              <h2 className="mt-2 text-2xl font-bold text-foreground">For Growing Clinics</h2>
              <p className="mt-2 text-sm leading-6 text-muted-foreground">
                    ...
                    <button
                      ...
                      className={`rounded-2xl border p-3.5 text-left transition ${
                        isActive
                          ...
                          : "border-border bg-card/88 hover:border-[#224bc3]/25 hover:bg-card"
                      }`}
                    >
              ...
              <div className="mt-5 rounded-2xl border border-border bg-card/90 p-4">
                <p className="text-sm text-muted-foreground">Selected tier total</p>
                <p className="mt-1 text-3xl font-extrabold text-foreground">{formatInr(activeClinicTier.total)}</p>
              ...
              <div className="mt-7 grid gap-2.5 sm:grid-cols-2">
                <button
                  ...
                  className="inline-flex h-11 items-center justify-center rounded-full border border-[#224bc3]/30 bg-card px-5 text-sm font-semibold text-[#224bc3] transition hover:bg-[#224bc3]/10"
                >
                  Customize Plan
                </button>
                <button
            ...
            <section className="rounded-[2rem] border border-border bg-card/90 p-6 shadow-[0_18px_45px_-30px_rgba(0,0,0,0.6)] backdrop-blur transition duration-300 hover:-translate-y-1 hover:shadow-[0_26px_50px_-28px_rgba(0,0,0,0.55)]">
              ...
              <h2 className="mt-2 text-2xl font-bold text-foreground">Scale with API</h2>
              <p className="mt-2 text-sm leading-6 text-muted-foreground">
              ...
              <div className="mt-6 rounded-2xl border border-border bg-card/90 p-4">
                ...
                <p className="mt-1 text-3xl font-extrabold text-foreground">₹15 - ₹25</p>
                <p className="text-sm text-muted-foreground">per report for 1000+ reports</p>
              </div>
